...
car = pygame.image.load("D:\Journals\MSC AI PART 1\SEM 2\Decision Modeling\SPEED-RACER-master\data\images\Car.png")
car = pygame.transform.scale(car,(150,150)).convert_alpha()

road = pygame.image.load("D:\Journals\MSC AI PART 1\SEM 2\Decision Modeling\SPEED-RACER-master\data\images\Road.png")
road = pygame.transform.scale(road,(400,700)).convert_alpha()

sand = pygame.image.load("D:\Journals\MSC AI PART 1\SEM 2\Decision Modeling\SPEED-RACER-master\data\images\Sand.jpg")
sand = pygame.transform.scale(sand,(150,700)).convert_alpha()

leftDisp = pygame.image.load("D:\Journals\MSC AI PART 1\SEM 2\Decision Modeling\SPEED-RACER-master\data\images\LeftDisplay.png")
leftDisp = pygame.transform.scale(leftDisp,(250,700)).convert_alpha()

rightDisp = pygame.image.load("D:\Journals\MSC AI PART 1\SEM 2\Decision Modeling\SPEED-RACER-master\data\images\RightDisplay.png")
rightDisp = pygame.transform.scale(rightDisp,(250,700)).convert_alpha()

tree = pygame.image.load("D:\Journals\MSC AI PART 1\SEM 2\Decision Modeling\SPEED-RACER-master\data\images\Tree.png")
...
strip = pygame.image.load("D:\Journals\MSC AI PART 1\SEM 2\Decision Modeling\SPEED-RACER-master\data\images\Strip.png")
strip = pygame.transform.scale(strip,(25,90)).convert_alpha()
stripXY = [[593,0],[593,152.5],[593,305],[593,457.5],[593,610]]

explosion = pygame.image.load("D:\Journals\MSC AI PART 1\SEM 2\Decision Modeling\SPEED-RACER-master\data\images\Explosion.png")
explosion = pygame.transform.scale(explosion,(290,164)).convert_alpha()

fuel = pygame.image.load("D:\Journals\MSC AI PART 1\SEM 2\Decision Modeling\SPEED-RACER-master\data\images\Fuel.png")
...
def gameLoop():
    ...
    pygame.mixer.music.load("D:\Journals\MSC AI PART 1\SEM 2\Decision Modeling\SPEED-RACER-master\data\audios\lmn.mp3")
    ...
    while not exitGame:
        if gameOver:
            ...
            pygame.mixer.music.load("D:\Journals\MSC AI PART 1\SEM 2\Decision Modeling\SPEED-RACER-master\data\audios\rtn.mp3")
            pygame.mixer.music.play()

            exitScreen = False
            go = pygame.image.load("D:\Journals\MSC AI PART 1\SEM 2\Decision Modeling\SPEED-RACER-master\data\images\GameOver.png")
            ...
            if carX > 720 or carX < 330:
                pygame.mixer.music.load("D:\Journals\MSC AI PART 1\SEM 2\Decision Modeling\SPEED-RACER-master\data\audios\Crash.mp3")
                pygame.mixer.music.play()
                gameOver = True
                explode = True
...
def homeScreen():
    ...
    background = pygame.image.load("D:\Journals\MSC AI PART 1\SEM 2\Decision Modeling\SPEED-RACER-master\data\images\Background.png")
